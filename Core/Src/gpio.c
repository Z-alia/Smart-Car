...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_DL_Pin|WIFI_CS_Pin|HCSR04_TRIG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_DL_Pin HCSR04_TRIG_Pin */
  GPIO_InitStruct.Pin = LCD_DL_Pin|HCSR04_TRIG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
