...
#define SCCB_SCL_PORT   		   SCCB_SCL_GPIO_Port               // SCL 引脚端口
#define SCCB_SCL_PIN     		   SCCB_SCL_Pin 					// SCL 引脚
        
#define SCCB_SDA_CLK_ENABLE       __HAL_RCC_GPIOB_CLK_ENABLE() 	// SDA 引脚时钟
#define SCCB_SDA_PORT   			 SCCB_SDA_GPIO_Port                   	// SDA 引脚端口
#define SCCB_SDA_PIN    			 SCCB_SDA_Pin              	// SDA 引脚
