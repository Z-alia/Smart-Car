...
// 
// 已确认 OV2640 有 24MHz 板载晶振
// 对于 188*120 分辨率: 188*120*2*30fps = 1.35MB/s，需要至少 1.35MHz PCLK
// 设置 PCLK = 48M / 6 = 8MHz，足够且不会太快
   {0xd3, 0x06},   // R_DVP_SP, PCLK = 48MHz / 6 = 8MHz (降低速度提高稳定性)
