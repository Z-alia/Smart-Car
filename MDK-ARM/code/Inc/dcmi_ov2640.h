...
extern uint16_t* mt9v03x_image[120];	// 图像数据存储数组
...
#define OV2640_Width          192//480   // 图像长度 
#define OV2640_Height         144//360  // 图像宽度
...
int8_t   OV2640_Init(void);	// 初始SCCB、DCMI、DMA以及配置OV2640
