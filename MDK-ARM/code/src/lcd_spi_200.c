...
//              ���Ҫ��ʾ��ֵ��ͼ�� ֱ���޸����һ������Ϊ��Ҫ�Ķ�ֵ����ֵ����
//-------------------------------------------------------------------------------------------------------------------
void show_ov2640_image (uint16_t x, uint16_t y, const uint16_t *image, uint16_t dis_width, uint16_t dis_height,uint8_t threshold,Image *image_buf)
{
...
// �޸�Ϊ16λ���ݿ��ȣ�д�����ݸ���Ч�ʣ�����Ҫ���	
   ...
   HAL_SPI_Init(&LCD_SPI);
    ...
    {
        image_temp = image + j * dis_width;                   // ֱ�Ӷ� image ������ Hardfault ��ʱ��֪��Ϊʲô
        if(threshold == 0)
        {
